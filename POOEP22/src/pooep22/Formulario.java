...
public class Formulario extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtHorasMes, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        double horasMes, pagoHora, salario;
        
        horasMes = Double.parseDouble( txtHorasMes.getText() );
        pagoHora = Double.parseDouble( txtPagoHora.getText() );
        salario = horasMes*pagoHora;
        
        if (salario > 450000) {
            txtResultado.setText(txtNombre.getText() + " " + salario);
        }
        else {
            txtResultado.setText(txtNombre.getText());
        }
